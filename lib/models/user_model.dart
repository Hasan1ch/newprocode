...
class UserModel {
  final String id;
  final String uid; // Added for compatibility
  final String email;
  ...
  final Map<String, ProgressModel> progress; // courseId: progress
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      'totalXP': totalXP,
      'xp': totalXP, // For backward compatibility
      'level': level,
      ...
      'joinDate': Timestamp.fromDate(createdAt),
